...
root.title("Ashwin's Name generator")
root.iconbitmap(r'C:\Users\HP\OneDrive\Documents\Projects\Python GUI Applications\Name Generator\Icons\names.png')

l = Label(root,text="Ashwin's Name Generator App",font=('verdana',15,'bold'),bg="maroon",fg="white")
l.place(x=180, y=10)
